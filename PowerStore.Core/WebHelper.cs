...
namespace PowerStore.Core
{
    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        public virtual bool IsPostBeingDone {
            get {
                if (_httpContextAccessor.HttpContext.Items["PowerStore.IsPOSTBeingDone"] == null)
                    return false;

                return Convert.ToBoolean(_httpContextAccessor.HttpContext.Items["PowerStore.IsPOSTBeingDone"]);
            }
            set {
                _httpContextAccessor.HttpContext.Items["PowerStore.IsPOSTBeingDone"] = value;
            }
        }
