...
using PowerStore.Core.Roslyn;
using PowerStore.Domain.MongoDB;
...
namespace PowerStore.Core
{
    ...
    public static class Engine
    {
        ...
        public static void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            var startupConfigurations = typeFinder.FindClassesOfType<IPowerStoreStartup>();
            ...
            var instances = startupConfigurations
                ...
                .Select(startup => (IPowerStoreStartup)Activator.CreateInstance(startup))
