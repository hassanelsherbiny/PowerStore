...
namespace PowerStore.Core.ModelBinding
{
    ...
    /// </summary>
    public class PowerStoreMetadataProvider : IDisplayMetadataProvider
    {
        /// <summary>
        ...
        public void CreateDisplayMetadata(DisplayMetadataProviderContext context)
        {
            ...
            foreach (var additionalValue in additionalValues)
            {
                if (context.DisplayMetadata.AdditionalValues.ContainsKey(additionalValue.Name))
                    throw new PowerStoreException($"There is already an attribute with the name {additionalValue.Name} on this model");
