...
namespace PowerStore.Core.TypeFinders
{
    /// <summary>
    /// A class that finds types needed by PowerStore by looping assemblies in the 
    ...
    public class TypeFinder : ITypeFinder
    {
        ...
        /// <returns>A list of assemblies that should be loaded by the PowerStore factory.</returns>
