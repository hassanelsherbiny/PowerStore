...
using PowerStore.Web.Commands.Models.Common;
...
namespace PowerStore.Web.Controllers
{
    public partial class CommonController : BasePublicController
    {
        ...
        public virtual async Task<IActionResult> SetLanguage(
            ...
            [FromServices] PowerStoreConfig config,
        ...
        public virtual IActionResult InternalRedirect(string url, bool permanentRedirect)
        {
            ...
            if (HttpContext.Items["PowerStore.RedirectFromGenericPathRoute"] == null ||
                !Convert.ToBoolean(HttpContext.Items["PowerStore.RedirectFromGenericPathRoute"]))
            {
