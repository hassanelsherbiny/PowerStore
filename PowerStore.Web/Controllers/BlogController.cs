...
using PowerStore.Framework.Mvc.Rss;
...
using PowerStore.Web.Commands.Models.Blogs;
    ...
    public partial class BlogController : BasePublicController
    {
        ...
        public virtual async Task<IActionResult> BlogCommentAdd(string blogPostId, BlogPostModel model, bool captchaValid)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                TempData["PowerStore.blog.addcomment.result"] = _localizationService.GetResource("Blog.Comments.SuccessfullyAdded");
