...
namespace PowerStore.Web.Features.Handlers.Catalog
{
    public class GetCategoryHandler : IRequestHandler<GetCategory, CategoryModel>
    {
        ...
        public async Task<CategoryModel> Handle(GetCategory request, CancellationToken cancellationToken)
        {
            ...
            //price ranges
            await model.PagingFilteringContext.PriceRangeFilter.LoadPriceRangeFilters(request.Category.PriceRanges, _webHelper, _priceFormatter, _currencyService, request.Currency);
