...
namespace PowerStore.Web.Models.Vendors
{
    ...
    {
        [PowerStoreResourceDisplayName("Reviews.Fields.Title")]
        public string Title { get; set; }

        [PowerStoreResourceDisplayName("Reviews.Fields.ReviewText")]
        public string ReviewText { get; set; }

        [PowerStoreResourceDisplayName("Reviews.Fields.Rating")]
        public int Rating { get; set; }
