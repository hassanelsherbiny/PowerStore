...
namespace PowerStore.Web.Models.Orders
{
    public partial class ReturnRequestModel : BaseModel
    {
        ...
        [PowerStoreResourceDisplayName("ReturnRequests.Comments")]
        ...
        public partial class OrderItemModel : BaseEntityModel
        {
            ...
            [PowerStoreResourceDisplayName("ReturnRequests.ReturnReason")]
            public string ReturnRequestReasonId { get; set; }

            [PowerStoreResourceDisplayName("ReturnRequests.ReturnAction")]
