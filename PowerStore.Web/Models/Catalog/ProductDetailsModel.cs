...
namespace PowerStore.Web.Models.Catalog
{
    public partial class ProductDetailsModel : BaseEntityModel
    {
        ...
        public partial class AddToCartModel : BaseModel
        {
            ...
            public string ProductId { get; set; }
            //qty
            [PowerStoreResourceDisplayName("Products.Qty")]
            public int EnteredQuantity { get; set; }
            public string MinimumQuantityNotification { get; set; }
            public List<SelectListItem> AllowedQuantities { get; set; }
            //price entered by customers
            [PowerStoreResourceDisplayName("Products.EnterProductPrice")]
        ...
        public partial class GiftCardModel : BaseModel
        {
            ...
            [PowerStoreResourceDisplayName("Products.GiftCard.RecipientName")]
            public string RecipientName { get; set; }
            [PowerStoreResourceDisplayName("Products.GiftCard.RecipientEmail")]
            public string RecipientEmail { get; set; }
            [PowerStoreResourceDisplayName("Products.GiftCard.SenderName")]
            public string SenderName { get; set; }
            [PowerStoreResourceDisplayName("Products.GiftCard.SenderEmail")]
            public string SenderEmail { get; set; }
            [PowerStoreResourceDisplayName("Products.GiftCard.Message")]
