...
namespace PowerStore.Web.Areas.Admin.Models.Settings
{
    public partial class OrderSettingsModel : BaseModel
    {
        ...
        [PowerStoreResourceDisplayName("Admin.Configuration.Settings.Order.IsReOrderAllowed")]
        public bool IsReOrderAllowed { get; set; }
        public bool IsReOrderAllowed_OverrideForStore { get; set; }

        [PowerStoreResourceDisplayName("Admin.Configuration.Settings.Order.MinOrderSubtotalAmount")]
        public decimal MinOrderSubtotalAmount { get; set; }
        public bool MinOrderSubtotalAmount_OverrideForStore { get; set; }

        [PowerStoreResourceDisplayName("Admin.Configuration.Settings.Order.MinOrderSubtotalAmountIncludingTax")]
        ...
        [PowerStoreResourceDisplayName("Admin.Configuration.Settings.Order.AnonymousCheckoutAllowed")]
        public bool AnonymousCheckoutAllowed { get; set; }
        public bool AnonymousCheckoutAllowed_OverrideForStore { get; set; }

        [PowerStoreResourceDisplayName("Admin.Configuration.Settings.Order.TermsOfServiceOnShoppingCartPage")]
        public bool TermsOfServiceOnShoppingCartPage { get; set; }
        public bool TermsOfServiceOnShoppingCartPage_OverrideForStore { get; set; }

        [PowerStoreResourceDisplayName("Admin.Configuration.Settings.Order.TermsOfServiceOnOrderConfirmPage")]
        public bool TermsOfServiceOnOrderConfirmPage { get; set; }
        public bool TermsOfServiceOnOrderConfirmPage_OverrideForStore { get; set; }

        [PowerStoreResourceDisplayName("Admin.Configuration.Settings.Order.OnePageCheckoutEnabled")]
        public bool OnePageCheckoutEnabled { get; set; }
        public bool OnePageCheckoutEnabled_OverrideForStore { get; set; }

        [PowerStoreResourceDisplayName("Admin.Configuration.Settings.Order.OnePageCheckoutDisplayOrderTotalsOnPaymentInfoTab")]
        ...
        [PowerStoreResourceDisplayName("Admin.Configuration.Settings.Order.DisableBillingAddressCheckoutStep")]
        public bool DisableBillingAddressCheckoutStep { get; set; }
        public bool DisableBillingAddressCheckoutStep_OverrideForStore { get; set; }

        [PowerStoreResourceDisplayName("Admin.Configuration.Settings.Order.DisableOrderCompletedPage")]
        public bool DisableOrderCompletedPage { get; set; }
        public bool DisableOrderCompletedPage_OverrideForStore { get; set; }

        [PowerStoreResourceDisplayName("Admin.Configuration.Settings.Order.AttachPdfInvoiceToOrderPlacedEmail")]
        ...
        [PowerStoreResourceDisplayName("Admin.Configuration.Settings.Order.AttachPdfInvoiceToOrderPaidEmail")]
        ...
        [PowerStoreResourceDisplayName("Admin.Configuration.Settings.Order.AttachPdfInvoiceToOrderCompletedEmail")]
        ...
        [PowerStoreResourceDisplayName("Admin.Configuration.Settings.Order.ReturnRequestsEnabled")]
        public bool ReturnRequestsEnabled { get; set; }
        public bool ReturnRequestsEnabled_OverrideForStore { get; set; }

        [PowerStoreResourceDisplayName("Admin.Configuration.Settings.Order.ReturnRequests_AllowToSpecifyPickupAddress")]
        ...
        [PowerStoreResourceDisplayName("Admin.Configuration.Settings.Order.ReturnRequests_AllowToSpecifyPickupDate")]
        ...
        [PowerStoreResourceDisplayName("Admin.Configuration.Settings.Order.NumberOfDaysReturnRequestAvailable")]
        ...
        [PowerStoreResourceDisplayName("Admin.Configuration.Settings.Order.GiftCards_Activated")]
        ...
        [PowerStoreResourceDisplayName("Admin.Configuration.Settings.Order.DeactivateGiftCardsAfterCancelOrder")]
        public bool DeactivateGiftCardsAfterCancelOrder { get; set; }

        [PowerStoreResourceDisplayName("Admin.Configuration.Settings.Order.DeactivateGiftCardsAfterDeletingOrder")]
        public bool DeactivateGiftCardsAfterDeletingOrder { get; set; }

        [PowerStoreResourceDisplayName("Admin.Configuration.Settings.Order.CompleteOrderWhenDelivered")]
        public bool CompleteOrderWhenDelivered { get; set; }

        public string PrimaryStoreCurrencyCode { get; set; }

        [PowerStoreResourceDisplayName("Admin.Configuration.Settings.Order.OrderIdent")]
        public int? OrderIdent { get; set; }

        [PowerStoreResourceDisplayName("Admin.Configuration.Settings.Order.UserCanCancelUnpaidOrder")]
        public bool UserCanCancelUnpaidOrder { get; set; }
        public bool UserCanCancelUnpaidOrder_OverrideForStore { get; set; }

        [PowerStoreResourceDisplayName("Admin.Configuration.Settings.Order.AllowCustomerToAddOrderNote")]
        public bool AllowCustomerToAddOrderNote { get; set; }
        public bool AllowCustomerToAddOrderNote_OverrideForStore { get; set; }

        [PowerStoreResourceDisplayName("Admin.Configuration.Settings.Order.DaysToCancelUnpaidOrder")]
