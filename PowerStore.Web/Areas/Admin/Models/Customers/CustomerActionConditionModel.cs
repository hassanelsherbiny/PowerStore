...
namespace PowerStore.Web.Areas.Admin.Models.Customers
{
    public partial class CustomerActionConditionModel : BaseEntityModel
    {
        ...
        [PowerStoreResourceDisplayName("Admin.Customers.CustomerActionCondition.Fields.Name")]
        public string Name { get; set; }

        [PowerStoreResourceDisplayName("Admin.Customers.CustomerActionCondition.Fields.CustomerConditionTypeId")]
        public int CustomerActionConditionTypeId { get; set; }
        public IList<SelectListItem> CustomerActionConditionType { get; set; }

        [PowerStoreResourceDisplayName("Admin.Customers.CustomerActionCondition.Fields.ConditionId")]
