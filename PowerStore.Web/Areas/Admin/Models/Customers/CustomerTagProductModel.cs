...
namespace PowerStore.Web.Areas.Admin.Models.Customers
{
    ...
    {
        [PowerStoreResourceDisplayName("Admin.Customers.CustomerTags.Products.Fields.Name")]
        
        public string Name { get; set; }

        [PowerStoreResourceDisplayName("Admin.Customers.CustomerTags.Products.Fields.DisplayOrder")]
