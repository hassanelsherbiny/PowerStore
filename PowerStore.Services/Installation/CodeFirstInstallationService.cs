...
namespace PowerStore.Services.Installation
{
    public partial class CodeFirstInstallationService : IInstallationService
    {
        ...
        private readonly IRepository<PowerStoreVersion> _versionRepository;
        ...
        {
            _versionRepository = serviceProvider.GetRequiredService<IRepository<PowerStoreVersion>>();
            ...
            var news = new List<NewsItem>
                                {
                                    ...
                                    {
                                         AllowComments = false,
                                         Title = "About PowerStore",
                                         Short = "It's stable and highly usable. From downloads to documentation, www.PowerStore.com offers a comprehensive base of information, resources, and support to the PowerStore community.",
                                         Full = "<p>For full feature list go to <a href=\"http://www.PowerStore.com\">PowerStore.com</a></p><p>Providing outstanding custom search engine optimization, web development services and e-commerce development solutions to our clients at a fair price in a professional manner.</p>",
                                         Published  = true,
                                         CreatedOnUtc = DateTime.UtcNow,
                                    },
                                    new NewsItem
                                    {
                                         AllowComments = false,
                                         Title = "PowerStore new release!",
                                         Short = "PowerStore includes everything you need to begin your e-commerce online store. We have thought of everything and it's all included! PowerStore is a fully customizable shopping cart",
                                         Full = "<p>PowerStore includes everything you need to begin your e-commerce online store. We have thought of everything and it's all included!</p>",
                                         Published  = true,
                                         CreatedOnUtc = DateTime.UtcNow.AddSeconds(1),
                                    },
                                    new NewsItem
                                    {
                                         ...
                                         Short = "The new PowerStore store is open now! We are very excited to offer our new range of products. We will be constantly adding to our range so please register on our site.",
        ...
        {
            //version
            await _versionRepository.Collection.Indexes.CreateOneAsync(new CreateIndexModel<PowerStoreVersion>((Builders<PowerStoreVersion>.IndexKeys.Ascending(x => x.DataBaseVersion)), new CreateIndexOptions() { Name = "DataBaseVersion", Unique = true }));
