...
using PowerStore.Domain.Affiliates;
...
namespace PowerStore.Services.Installation
{
    public partial class CodeFirstInstallationService : IInstallationService
    {
        ...
        {
            _versionRepository = serviceProvider.GetRequiredService<IRepository<PowerStoreNodeVersion>>();
        ...
        {
            var version = new PowerStoreNodeVersion {
        ...
        protected virtual async Task InstallSettings(bool installSampleData)
        {
            ...
            await _settingService.SaveSetting(new StoreInformationSettings {
                ...
                FacebookLink = "https://www.facebook.com/PowerStorenodecom",
                TwitterLink = "https://twitter.com/PowerStorenode",
                YoutubeLink = "http://www.youtube.com/user/PowerStorenode",
                InstagramLink = "https://www.instagram.com/PowerStorenode/",
                LinkedInLink = "https://www.linkedin.com/company/PowerStorenode.com/",
                PinterestLink = "",
            });
            ...
            var news = new List<NewsItem>
                                {
                                    ...
                                    {
                                         AllowComments = false,
                                         Title = "About PowerStorenode",
                                         Short = "It's stable and highly usable. From downloads to documentation, www.PowerStorenode.com offers a comprehensive base of information, resources, and support to the PowerStorenode community.",
                                         Full = "<p>For full feature list go to <a href=\"http://www.PowerStorenode.com\">PowerStorenode.com</a></p><p>Providing outstanding custom search engine optimization, web development services and e-commerce development solutions to our clients at a fair price in a professional manner.</p>",
                                         Published  = true,
                                         CreatedOnUtc = DateTime.UtcNow,
                                    },
                                    new NewsItem
                                    {
                                         AllowComments = false,
                                         Title = "PowerStorenode new release!",
                                         Short = "PowerStorenode includes everything you need to begin your e-commerce online store. We have thought of everything and it's all included! PowerStorenode is a fully customizable shopping cart",
                                         Full = "<p>PowerStorenode includes everything you need to begin your e-commerce online store. We have thought of everything and it's all included!</p>",
                                         Published  = true,
                                         CreatedOnUtc = DateTime.UtcNow.AddSeconds(1),
                                    },
                                    new NewsItem
                                    {
                                         ...
                                         Short = "The new PowerStorenode store is open now! We are very excited to offer our new range of products. We will be constantly adding to our range so please register on our site.",
        ...
        protected virtual async Task InstallScheduleTasks()
        {
            ...
            new ScheduleTask
            {
                    ...
                    Type = "PowerStore.Services.Tasks.QueuedMessagesSendScheduleTask, PowerStore.Services",
                    Enabled = true,
                    StopOnError = false,
                    TimeInterval = 1
                },
                new ScheduleTask
                {
                    ...
                    Type = "PowerStore.Services.Tasks.DeleteGuestsScheduleTask, PowerStore.Services",
                    Enabled = true,
                    StopOnError = false,
                    TimeInterval = 1440
                },
                new ScheduleTask
                {
                    ...
                    Type = "PowerStore.Services.Tasks.ClearCacheScheduleTask, PowerStore.Services",
                    Enabled = false,
                    StopOnError = false,
                    TimeInterval = 120
                },
                new ScheduleTask
                {
                    ...
                    Type = "PowerStore.Services.Tasks.ClearLogScheduleTask, PowerStore.Services",
                    Enabled = false,
                    StopOnError = false,
                    TimeInterval = 1440
                },
                new ScheduleTask
                {
                    ...
                    Type = "PowerStore.Services.Tasks.UpdateExchangeRateScheduleTask, PowerStore.Services",
                    Enabled = true,
                    StopOnError = false,
                    TimeInterval = 1440
                },
                new ScheduleTask
                {
                    ...
                    Type = "PowerStore.Services.Tasks.CustomerReminderAbandonedCartScheduleTask, PowerStore.Services",
                    Enabled = false,
                    StopOnError = false,
                    TimeInterval = 20
                },
                new ScheduleTask
                {
                    ...
                    Type = "PowerStore.Services.Tasks.CustomerReminderRegisteredCustomerScheduleTask, PowerStore.Services",
                    Enabled = false,
                    StopOnError = false,
                    TimeInterval = 1440
                },
                new ScheduleTask
                {
                    ...
                    Type = "PowerStore.Services.Tasks.CustomerReminderLastActivityScheduleTask, PowerStore.Services",
                    Enabled = false,
                    StopOnError = false,
                    TimeInterval = 1440
                },
                new ScheduleTask
                {
                    ...
                    Type = "PowerStore.Services.Tasks.CustomerReminderLastPurchaseScheduleTask, PowerStore.Services",
                    Enabled = false,
                    StopOnError = false,
                    TimeInterval = 1440
                },
                new ScheduleTask
                {
                    ...
                    Type = "PowerStore.Services.Tasks.CustomerReminderBirthdayScheduleTask, PowerStore.Services",
                    Enabled = false,
                    StopOnError = false,
                    TimeInterval = 1440
                },
                new ScheduleTask
                {
                    ...
                    Type = "PowerStore.Services.Tasks.CustomerReminderCompletedOrderScheduleTask, PowerStore.Services",
                    Enabled = false,
                    StopOnError = false,
                    TimeInterval = 1440
                },
                new ScheduleTask
                {
                    ...
                    Type = "PowerStore.Services.Tasks.CustomerReminderUnpaidOrderScheduleTask, PowerStore.Services",
                    Enabled = false,
                    StopOnError = false,
                    TimeInterval = 1440
                },
                new ScheduleTask
                {
                    ...
                    Type = "PowerStore.Services.Tasks.EndAuctionsTask, PowerStore.Services",
                    Enabled = false,
                    StopOnError = false,
                    TimeInterval = 60
                },
                new ScheduleTask
                {
                    ...
                    Type = "PowerStore.Services.Tasks.CancelOrderScheduledTask, PowerStore.Services",
                    Enabled = false,
                    StopOnError = false,
                    TimeInterval = 1440
                },
        ...
        {
            //version
            await _versionRepository.Collection.Indexes.CreateOneAsync(new CreateIndexModel<PowerStoreNodeVersion>((Builders<PowerStoreNodeVersion>.IndexKeys.Ascending(x => x.DataBaseVersion)), new CreateIndexOptions() { Name = "DataBaseVersion", Unique = true }));
        ...
        private async Task CreateTables(string local)
        {
            ...
            try
            {
                ...
                var q = typeFinder.GetAssemblies().FirstOrDefault(x => x.GetName().Name == "PowerStore.Domain");
            ...
            {
                throw new PowerStoreException(ex.Message);
            }
        }
