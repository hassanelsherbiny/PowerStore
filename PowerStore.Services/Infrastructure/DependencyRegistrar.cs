...
using PowerStore.Services.ExportImport;
...
using PowerStore.Services.MachineNameProvider;
...
using PowerStore.Services.PushNotifications;
...
using PowerStore.Services.Tasks;
...
namespace PowerStore.Services.Infrastructure
{
    /// <summary>
    ...
    public class DependencyInjection : IDependencyInjection
    {
        ...
        private void RegisterMachineNameProvider(IServiceCollection serviceCollection, PowerStoreConfig config)
        {
        ...
        {
            serviceCollection.AddScoped<IPowerStoreAuthenticationService, CookieAuthenticationService>();
        ...
        private void RegisterMediaService(IServiceCollection serviceCollection, PowerStoreConfig config)
        {
