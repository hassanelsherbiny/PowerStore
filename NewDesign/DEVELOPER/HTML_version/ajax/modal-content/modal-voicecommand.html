...
<div class="modal-body">
	...
	Voice Command supports up to 80 languages. Adding your own commands is extreamly easy. All commands are stored in the <strong>app.config.js</strong> file under the <code>var commands = {...}</code>. 
