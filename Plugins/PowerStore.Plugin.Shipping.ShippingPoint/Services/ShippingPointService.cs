...
namespace PowerStore.Plugin.Shipping.ShippingPoint.Services
{
    public class ShippingPointService : IShippingPointService
    {
        #region Constants

        private const string PICKUP_POINT_PATTERN_KEY = "PowerStore.ShippingPoint.";
        ...
        public ShippingPointService(ICacheBase cacheManager,
