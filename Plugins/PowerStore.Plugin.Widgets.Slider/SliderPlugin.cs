    ...
    public class SliderPlugin : BasePlugin, IWidgetPlugin
    {
        ...
        public override async Task Install()
        {
            ...
            await _pictureSliderRepository.InsertAsync(new PictureSlider()
            {
                ...
                Published = true,
                PictureId = pic2.Id,
                Description = "<div class=\"row slideRow\"><div class=\"col-md-6 offset-md-6 col-12 offset-0 d-flex flex-column justify-content-center align-items-start px-0 pr-md-3\"><div class=\"slide-title text-dark animate__animated animate__fadeInRight animate__delay-05s\"><h2 class=\"mt-0\">Iphone 13 Pro Max</h2></div><div class=\"slide-content animate__animated animate__fadeInRight animate__delay-1s\"><p class=\"mb-0\"><span>Equipped with a high-performance octa-core processor <br/> with a maximum clock frequency of 2.0 GHz.</span></p></div><div class=\"slide-price animate__animated animate__fadeInRight animate__delay-15s d-inline-flex align-items-center justify-content-start w-100 mt-2\"><p class=\"actual\">$1249.00</p><p class=\"old-price\">$1399.00</p></div><div class=\"slide-button animate__animated animate__fadeInRight animate__delay-2s mt-3\"><a class=\"btn btn-outline-info\" href=\"/Iphone-13-Pro-Max\">BUY Iphone Pro Max 13</a></div></div></div>",
            });
        ...
        {
            viewComponentName = "PowerStore.Plugin.Widgets.Slider";
        }
