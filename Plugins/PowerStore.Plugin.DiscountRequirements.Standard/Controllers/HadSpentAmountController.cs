...
using PowerStore.Plugin.DiscountRequirements.Standard.HadSpentAmount.Models;
...
namespace PowerStore.Plugin.DiscountRequirements.Standard.HadSpentAmount.Controllers
{
    [Area("Admin")]
    [AuthorizeAdmin]
