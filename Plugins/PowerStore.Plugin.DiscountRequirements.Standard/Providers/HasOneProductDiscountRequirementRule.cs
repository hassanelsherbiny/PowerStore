...
namespace PowerStore.Plugin.DiscountRequirements.HasOneProduct
{
    public partial class HasOneProductDiscountRequirementRule : IDiscountRequirementRule
    {
        ...
        public HasOneProductDiscountRequirementRule(ISettingService settingService, ShoppingCartSettings shoppingCartSettings)
        {
