...
namespace PowerStore.Framework.Mvc.Routing
{
    /// <summary>
    /// Represents custom overridden redirect result executor
    /// </summary>
    public class PowerStoreRedirectResultExecutor : RedirectResultExecutor
    {
        #region Fields
        ...
        public PowerStoreRedirectResultExecutor(ILoggerFactory loggerFactory,
