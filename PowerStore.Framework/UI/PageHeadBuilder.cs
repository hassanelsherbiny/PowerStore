            ...
            if (bundleFiles.Value)
            {
                ...
                if (partsToBundle.Any())
                {
                    ...
                    foreach (var item in partsToBundle)
                    {
                        ...
                        if (PowerStore.Core.OperatingSystem.IsWindows())
                    ...
                    //save
                    string configFilePath = _hostingEnvironment.ContentRootPath + (PowerStore.Core.OperatingSystem.IsWindows() ? "\\" : "/") + outputFileName + ".json";
                    ...
                    var fileNames = filePaths.Select(x => x.Substring(x.LastIndexOf((PowerStore.Core.OperatingSystem.IsWindows() ? "\\" : "/")) + 1));
                    ...
                    //render
                    if (File.Exists(bundleDirectory + (PowerStore.Core.OperatingSystem.IsWindows() ? "\\" : "/") + outputFileName + ".min.js"))
            ...
            if (bundleFiles.Value)
            {
                ...
                if (partsToBundle.Any())
                {
                    ...
                    foreach (var item in partsToBundle)
                    {
                        ...
                        src = urlHelper.Content(src);
                        //check whether this file exists 
                        var srcPath = PowerStore.Core.OperatingSystem.IsWindows() ?
                    ...
                    //render
                    if (File.Exists(bundleDirectory + (PowerStore.Core.OperatingSystem.IsWindows() ? "\\" : "/") + outputFileName + ".min.css"))
